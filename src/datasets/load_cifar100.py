...
if __name__ == '__main__':
    datasets = load_cifar100_superclass(is_train=True, superclass_type='predefined', 
                                        target_superclass_idx=0, n_classes=10, reorganize=True)
    print(sum(datasets.targets))
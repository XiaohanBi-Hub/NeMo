...
class VGG(nn.Module):
    ...
    def __init__(
        ...
        self.classifier = nn.Sequential(
            nn.Linear(n_last_conv_kernels, feature_dim),
            nn.ReLU(True),
            nn.Dropout(),
...
def _vgg(arch: str, cfg: str, batch_norm: bool,
    ...
    module = VGG(make_layers(module_cfg, kn_zoom=kn_zoom, batch_norm=batch_norm, module_layer_masks=module_layer_masks, keep_generator=keep_generator),
                 n_last_conv_kernels=module_cfg[-2], kn_zoom=kn_zoom, **kwargs)

...
batch_size = 128
script_path = "modularizer_deit.py"
cuda_device = 0
...
for alpha in alpha_list:
    for i in range(1,10):
        ...
        output_path = f"./DeiT_logs_contra/modularizer_logs_{model}_{dataset}_txt/lr_{lr_model}_{lr_mask}_a{alpha}_t{temperature}_bs_{batch_size}_tc{tc_str}.log"

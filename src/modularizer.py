...
if __name__ == '__main__':
    ...
    if kn_zoom == 1.0:
        save_dir = f'{configs.data_dir}/modular_trained/{model_name}_{dataset_name}_MwT'
    else:
        save_dir = f'{configs.data_dir}/modular_trained/{model_name}_{kn_zoom}_{dataset_name}_MwT'
    ...
    modules_save_path = f'{save_dir}/modules/' \
                        f'lr_model_mask_{lr_model}_{lr_mask}_a_{alpha}_b{beta}_bz_{batch_size}/module_tc_{tc_str}_thres_{THRESHOLD}.pth'
